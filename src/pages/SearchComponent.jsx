        ...
        <div className="flex items-center p-4 border-b">
          <div className="relative flex-1">
            ...
            <input
              ref={searchInputRef}
              type="text"
              className="w-full pl-10 pr-10 py-3 border rounded-full focus:outline-none focus:ring-2 focus:ring-red-500"
              placeholder="Search..."
              value={searchText}
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          type="text"
          className="w-full pl-10 pr-10 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm"
