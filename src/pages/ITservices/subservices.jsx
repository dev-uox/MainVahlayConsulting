...
const SubserviceDetailPage = () => {
  ...
  const handlePhoneChange = (status, value) => setPhone(value);
              ...
              <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-slate-100 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <IntlTelInput preferredCountries={["us", "gb", "in"]} value={phone} onPhoneNumberChange={handlePhoneChange} containerClassName="intl-tel-input w-full" inputClassName="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:border-red-500 outline-none" />
                    <input type="text" name="companyName" value={formData.companyName} onChange={handleChange} placeholder="Company*" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:border-red-500 outline-none" required />
                  </div>
