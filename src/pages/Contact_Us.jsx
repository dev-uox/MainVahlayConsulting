            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all text-sm font-medium text-slate-900 placeholder:text-slate-400"
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all text-sm font-medium text-slate-900 placeholder:text-slate-400 h-32 resize-none"
